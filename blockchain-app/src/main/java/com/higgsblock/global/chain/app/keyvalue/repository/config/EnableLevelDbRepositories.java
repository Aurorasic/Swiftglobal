...
import com.higgsblock.global.chain.app.keyvalue.repository.query.IndexedCachingKeyValuePartTreeQuery;
...
@Documented
@Inherited
@Import(LevelDbRepositoriesRegistrar.class)
@QueryCreatorType(value = SpelQueryCreator.class, repositoryQueryType = IndexedCachingKeyValuePartTreeQuery.class)
public @interface EnableLevelDbRepositories {
