...
import static cn.primeledger.cas.global.p2p.handler.FrameHandler.Frame;
...
@Slf4j
public class Frame2MessageHandler extends MessageToMessageCodec<Frame, BaseMessage> {
