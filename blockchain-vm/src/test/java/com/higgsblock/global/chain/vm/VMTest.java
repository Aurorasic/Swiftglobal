...
import com.higgsblock.global.chain.vm.program.Program.BadJumpDestinationException;
import com.higgsblock.global.chain.vm.program.Program.StackTooSmallException;
...
public class VMTest {
    ...
    public void testEXTCODECOPY_1() {
        ...
        String result = Hex.toHexString(program.getMemory()).toUpperCase();
        assertEquals(m_expected_1, result);
    }
