...
public class ServerInboundHandler extends BaseInboundHandler {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, BaseMessage msg) throws Exception {
        ...
        if (connection.isActivated()) {
            ...
            //todo kongyu 2018-4-25 20:33 add clearPeerRetries Update peer
            Peer peer = ((HelloMessage) msg).getPeer();
            //When the server receives the helloMsg message sent from the client connection for the first time, retries must be reset to 0
