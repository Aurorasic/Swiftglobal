...
/**
 * The connection manager holds all connections. which manages all connections' state and count.
 *
...
public class ConnectionManager {
    ...
    private static final int CLIENT_CONN_LIMIT = 15;
    private static final int SERVER_CONN_LIMIT = 16;
    ...
    public void remove(Connection connection) {
        ...
        LOGGER.info("remove disconnection peer info connection={}", connection);
    }
